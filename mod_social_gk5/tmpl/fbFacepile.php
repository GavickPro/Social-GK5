...
<?php else : ?>
<?php echo '<div class="fb-facepile" data-href="'.$this->config['fb_site'].'" data-width="'.$this->config['fb_facepile_width'].'" data-max-rows="'.$this->config['fb_facepile_num_rows'].'" data-size="'.$this->config['fb_facepile_size'].'" data-colorscheme="'.$this->config['fb_facepile_colorscheme'].'"></div>'; ?>
<?php endif; ?>