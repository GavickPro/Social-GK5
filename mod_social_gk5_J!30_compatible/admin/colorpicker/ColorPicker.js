...
Refresh.Web.ColorPicker = new Class({
	...
	initialize: function(id, options) {
		...
		this._mapL1 = new Element('img',{src:this.options.clientFilesPath + 'blank.gif', width:256, height:256, styles: { 
            margin: 0,
            position: "absolute",
            left: 0,
            top: 0
            }} ).injectInside(this._mapBase);
		this._mapL2 = new Element('img',{src:this.options.clientFilesPath + 'blank.gif', width:256, height:256, styles: {
            clear: "both",
            margin: 0,
            position: "absolute",
            left: 0,
		...
		this._barL1 = new Element('img',{src:this.options.clientFilesPath + 'blank.gif', width:20, height:256});
		...
		this._barL2 = new Element('img',{src:this.options.clientFilesPath + 'blank.gif', width:20, height:256} );
		this._barL1.style.margin = '0px';
		this._barL1.style.position = 'absolute';
		this._barL1.style.left = '0px';
		this._barL1.style.top = '0px';
		...
		this._barL3 = new Element('img',{src:this.options.clientFilesPath + 'blank.gif', width:20, height:256} );
		...
		this._barL4 = new Element('img',{src:this.options.clientFilesPath + 'bar-brightness.png', width:20, height:256} );
		...
		// attach map slider
		this._map = new Refresh.Web.Slider(this._mapL2, {xMaxValue: 255, yMinValue: 255, arrowImage: this.options.clientFilesPath + 'mappoint.gif'});

		// attach color slider
		this._slider = new Refresh.Web.Slider(this._barL4, {xMinValue: 1,xMaxValue: 1, yMinValue: 255, arrowImage: this.options.clientFilesPath + 'rangearrows.gif'});;
